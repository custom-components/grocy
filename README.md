...
2. In the 'Network' section of the add-on config, input 9192 in the host field ( [look at screenshot](https://github.com/custom-components/grocy/raw/develop/grocy-addon-config.png) ). Save your changes and restart the add-on.
