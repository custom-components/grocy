...
class GrocyData:
    ...
    async def async_update_chores(self):
        ...
        self.hass.data[DOMAIN_DATA][
            CHORES_NAME
        ] = await self.hass.async_add_executor_job(self.client.chores)
    ...
    async def async_update_expired_products(self):
        ...
        self.hass.data[DOMAIN_DATA][
            EXPIRED_PRODUCTS_NAME
        ] = await self.hass.async_add_executor_job(self.client.expired_products, [True])
    ...
    async def async_update_missing_products(self):
        ...
        self.hass.data[DOMAIN_DATA][
            MISSING_PRODUCTS_NAME
        ] = await self.hass.async_add_executor_job(self.client.missing_products, [True])
